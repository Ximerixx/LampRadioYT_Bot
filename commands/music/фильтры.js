module.exports = {
    name: 'фильтры',
    aliases: ['filters', 'фильтры' , 'эффекты'],
    category: 'Music',
    utilisation: '{prefix}фильтры',
    ...
    execute(client, message) {
        ...
        message.channel.send({
            embed: {
                ...
                timestamp: new Date(),
                description: `Весь список фильтров.\nДля использования надо ввести \`${client.config.discord.prefix}filter\` и немного подождать.`,
            },
        });
    },
};
